                            ...
                            <form role="form">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="exampleInputMan_on">Man_on</label>
                                                <input type="number" class="form-control" id="exampleInputMan_on"
                                                       placeholder=" Enter Man_on">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputFull_Name"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmployeeDesignation">Employee designation</label>
                                                <input type="date" class="form-control" id="exampleInputEmployessdesignation"
                                                       placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputarea"
                                                       placeholder="Enter area">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="exampleInputreviewaction">Review Action</label>
                                                <input type="text" class="form-control" id="exampleInputReviewAction"
                                                       placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">System</label>
